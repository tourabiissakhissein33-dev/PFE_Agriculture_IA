...
Le \textbf{Chapitre 3 --- Implémentation et Développement} détaille
...
Le \textbf{Chapitre 4 --- Tests et Résultats} présente le protocole
de tests, les résultats obtenus pour chaque module, la validation
du module Historique, une discussion générale et le déploiement
de l'application.
